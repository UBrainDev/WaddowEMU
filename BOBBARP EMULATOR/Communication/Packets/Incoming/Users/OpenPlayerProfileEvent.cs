...
namespace Plus.Communication.Packets.Incoming.Users
{
    class OpenPlayerProfileEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (targetData == null)
            {
                Session.SendNotification("Impossible d'ouvrir le profil.");
                return;
            }
            ...
            PlusEnvironment.GetGame().GetWebEventManager().SendDataDirect(Session, "profilUser;" + targetData.Username + ";" + targetData.Id);
        }
    }
}
