...
namespace Plus.HabboHotel
{
    public class Game
    {
        ...
        private readonly GroupRankManager _groupRankManager;
        ...
        public Game()
        {
            ...
            this._groupRankManager = new GroupRankManager();
        ...
        public GroupRankManager getGroupRankManager()
        {
            return _groupRankManager;
        }
