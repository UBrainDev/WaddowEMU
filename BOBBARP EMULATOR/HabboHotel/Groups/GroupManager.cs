...
namespace Plus.HabboHotel.Groups
{
    public class GroupManager
    {
                ...
                using (IQueryAdapter dbClient = PlusEnvironment.GetDatabaseManager().GetQueryReactor())
                {
                    ...
                    if (Row != null)
                    {
                        Group = new Group(
                            ...
                            Convert.ToInt32(Row["created"]), Convert.ToInt32(Row["state"]), Convert.ToInt32(Row["colour1"]), Convert.ToInt32(Row["colour2"]), Convert.ToInt32(Row["admindeco"]), Convert.ToInt32(Row["chiffre"]), Convert.ToInt32(Row["payedByGouv"]), Convert.ToInt32(Row["usine"]));
        ...
        {
            Group = new Group(0, Name, Description, Badge, RoomId, Player.Id, (int)PlusEnvironment.GetUnixTimestamp(), 0, Colour1, Colour2, 0, 0, 0, 0);
