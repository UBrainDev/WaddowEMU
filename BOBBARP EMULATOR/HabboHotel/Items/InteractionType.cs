    ...
    public class InteractionTypes
    {
        public static InteractionType GetTypeFromString(string pType)
        {
            switch (pType.ToLower())
            {
                ...
                case "douche":
                    return InteractionType.DOUCHE;
                case "casier":
                    return InteractionType.CASIER;
                case "cafe":
                    return InteractionType.CAFE;
                case "slot":
                    return InteractionType.SLOT;
                case "event":
                    return InteractionType.EVENT;
                case "cannabis":
                    return InteractionType.CANNABIS;
                case "distributeur":
                    return InteractionType.DISTRIBUTOR;
                case "tacos":
                    return InteractionType.TACOS;
                case "goulag":
                    return InteractionType.GOULAG;
                case "minepierre":
                ...
                case "panier":
                    return InteractionType.PANIER;
                case "ordinateur":
                    return InteractionType.ORDINATEUR;
                case "atm":
                    return InteractionType.ATM;
                case "rock":
                    return InteractionType.ROCK;
                case "robinet":
                    return InteractionType.ROBINET;
                case "lavabo":
                    return InteractionType.LAVABO;
                case "trash":
                    return InteractionType.TRASH;
                case "capture":
