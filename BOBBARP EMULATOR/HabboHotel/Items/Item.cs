        ...
        public IFurniInteractor Interactor
        {
            get
            {
                ...
                switch (GetBaseItem().InteractionType)
                {
                    ...
                    case InteractionType.DOUCHE:
                        return new InteractorDouche();

                    case InteractionType.CASIER:
                        return new InteractorCasier();

                    case InteractionType.CAFE:
                        return new InteractorCafe();

                    case InteractionType.SLOT:
                        return new InteractorSlot();

                    case InteractionType.EVENT:
                        return new InteractorEvent();

                    case InteractionType.CANNABIS:
                        return new InteractorCannabis();

                    case InteractionType.DISTRIBUTOR:
                        return new InteractorDistributor();
                    ...
                    case InteractionType.LOOK:
                        return new InteractorLook();

                    case InteractionType.CREATION:
                        return new InteractorCreation();

                    case InteractionType.PANIER:
                        return new InteractorPanier();

                    case InteractionType.ORDINATEUR:
                        return new InteractorOrdinateur();

                    case InteractionType.ATM:
                        return new InteractorATM();

                            case InteractionType.TRASH:
                        return new InteractorTrash();

                    case InteractionType.ROCK:
                        return new InteractorRock();

                    case InteractionType.ROBINET:
                        return new InteractorRobinet();

                    case InteractionType.LAVABO:
                        return new InteractorLavabo();

                    case InteractionType.CAPTURE:
                        return new InteractorCapture();
                                        ...
                                        if (User.Coordinate == Coordinate)
                                        {
                                            ...
                                            if (ItemTeleporterFinder.IsTeleLinked(Id, GetRoom()))
                                            {
                                                ...
                                                if (true)
                                                {
                                                    ...
                                                    if (RoomId == PlusEnvironment.Salade && PlusEnvironment.Salade != User.GetClient().GetHabbo().CurrentRoomId)
                                                    {
                                                    ...
                                                    if (RoomId == this.RoomId)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            if (User.GetClient().GetHabbo().MenottedUsername != null)
                                                            {
                                                                ...
                                                                Room Room = MenottedClient.GetHabbo().CurrentRoom;
                                                                RoomUser UserMenotted = Room.GetRoomUserManager().GetRoomUserByHabbo(MenottedClient.GetHabbo().Id);
                                                                UserMenotted.SetPos(Item.GetX, Item.GetY, Item.GetZ);
                                                                UserMenotted.SetRot(Item.Rotation, false);
                                                                GetRoom().GetGameMap().RemoveUserFromMap(UserMenotted, new Point(GetX, GetY));
                                                            }
                                                        }
                                                    }
                                                    else
                                                        ...
                                                        if (User.TeleDelay == 0)
                                                        {
                                                            ...
                                                            if (!User.IsBot && User != null && User.GetClient() != null && User.GetClient().GetHabbo() != null)
                                                            {
                                                                ...
                                                                if (User.GetClient().GetHabbo().MenottedUsername != null)
                                                                {
                                                                    ...
                                                                    MenottedClient.GetHabbo().TeleportingRoomID = RoomId;
                                                                    MenottedClient.GetHabbo().TeleporterId = TeleId;
                                                                    MenottedClient.GetHabbo().CanChangeRoom = true;
                                                                    MenottedClient.GetHabbo().PrepareRoom(RoomId, "");
                                                                }
                                                            }
                                                        }
                                                        else
