    ...
    public class InteractorDistributor : IFurniInteractor
    {
        ...
        public void OnTrigger(GameClient Session, Item Item, int Request, bool HasRights)
        {
            if (Item.ExtraData != "1" && Item.GetBaseItem().VendingIds.Count >= 1 && Item.InteractingUser == 0 && Session != null)
            {
                ...
                {
                    Session.SendWhisper("Il vous faut 4 crédits pour pouvoir utiliser le distributeur.");
                    return;
                }
                ...
                User.OnChat(User.LastBubble, "* Achète et mange un paquet de chips du distributeur [+" + Energie + "% ÉNERGIE, -4 CRÉDITS] *", true);
