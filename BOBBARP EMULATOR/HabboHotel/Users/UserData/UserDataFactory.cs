...
namespace Plus.HabboHotel.Users.UserDataManagement
{
    public class UserDataFactory
    {
        public static UserData GetUserData(string SessionTicket, out byte errorCode)
        {
            ...
            {
                dbClient.SetQuery("SELECT `id`,`username`,`rank`,`motto`,`look`,`gender`,`last_online`,`ip_last`,`credits`,`activity_points`,`home_room`,`block_newfriends`,`hide_online`,`hide_inroom`,`vip`,`account_created`,`vip_points`,`machine_id`,`volume`,`chat_preference`,`focus_preference`, `pets_muted`,`bots_muted`,`advertising_report_blocked`,`last_change`,`gotw_points`,`ignore_invites`,`time_muted`,`allow_gifts`,`friend_bar_state`,`disable_forced_effects`,`allow_mimic`,`rank_vip`,`gps`,`sante`,`energie`,`sommeil`,`hygiene`,`telephone`,`telephone_name`,`telephoneForfaitTel`,`telForfaitSms`,`telForfaitType`,`telForfaitReset`,`banque`,`savon`,`timer`,`prison`,`hopital`,`prison_count`,`morts`,`kills`,`coca`,`fanta`,`blur`,`audia8`,`porsche911`,`fiatpunto`,`volkswagenjetta`,`bmwi8`,`cb`,`sucette`,`pain`,`doliprane`,`mutuelle`,`mutuelle_expiration`,`gang`,`gang_rank`,`batte`,`sabre`,`ak47`,`ak47_munitions`,`uzi`,`uzi_munitions`,`pierre`,`confirmed`,`coiffure`,`policecasier`,`carte`,`facebook`,`sac`,`creations`,`permis_arme`,`clipper`,`weed`,`philipmo`,`event_day`,`event_points`,`casino_jetons`,`quizz_points`,`cocktails`,`white_hover`,`audia3`,`eau`,`casier_weed`,`casier_cocktails` FROM `users` WHERE `auth_ticket` = @sso LIMIT 1");
        ...
        public static UserData GetUserData(int UserId)
        {
            ...
            using (IQueryAdapter dbClient = PlusEnvironment.GetDatabaseManager().GetQueryReactor())
            {
                dbClient.SetQuery("SELECT `id`,`username`,`rank`,`motto`,`look`,`gender`,`last_online`,`ip_last`,`credits`,`activity_points`,`home_room`,`block_newfriends`,`hide_online`,`hide_inroom`,`vip`,`account_created`,`vip_points`,`machine_id`,`volume`,`chat_preference`, `focus_preference`, `pets_muted`,`bots_muted`,`advertising_report_blocked`,`last_change`,`gotw_points`,`ignore_invites`,`time_muted`,`allow_gifts`,`friend_bar_state`,`disable_forced_effects`,`allow_mimic`,`rank_vip`,`gps`,`sante`,`energie`,`sommeil`,`hygiene`,`telephone`,`telephone_name`,`telephoneForfaitTel`,`telForfaitSms`,`telForfaitType`,`telForfaitReset`,`banque`,`savon`,`timer`,`prison`,`hopital`,`prison_count`,`morts`,`kills`,`coca`,`fanta`,`blur`,`audia8`,`porsche911`,`fiatpunto`,`volkswagenjetta`,`bmwi8`,`cb`,`sucette`,`pain`,`doliprane`,`mutuelle`,`mutuelle_expiration`,`gang`,`gang_rank`,`batte`,`sabre`,`ak47`,`ak47_munitions`,`uzi`,`uzi_munitions`,`pierre`,`confirmed`,`coiffure`,`policecasier`,`carte`,`facebook`,`sac,`creations`,`permis_arme`,`clipper`,`weed`,`philipmo`,`event_day`,`event_points`,`casino_jetons`,`quizz_points`,`cocktails`,`white_hover`,`audia3`,`eau`,`casier_weed`,`casier_cocktails` FROM `users` WHERE `id` = @id LIMIT 1");
