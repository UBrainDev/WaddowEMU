...
namespace Bobba.HabboRoleplay.Web
{
    ...
    public sealed class WebEventManager
    {
        ...
        public void RegisterOutgoing()
        {
            ...
            this._webEvents.TryAdd("distributeur", new ATMWebEvent());
            ...
            this._webEvents.TryAdd("directeur", new DirecteurWebEvent());
            ...
            this._webEvents.TryAdd("casier", new CasierWebEvent());
        }
